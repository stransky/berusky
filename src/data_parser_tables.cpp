...
POSITION_TABLE_ITEM parser_table[] = 
{
  ...
  {"FIRST_BOX_BRIGHT", FIRST_BOX_BRIGHT},
  {"FIRST_BOX_DARK", FIRST_BOX_DARK},
  {"FIRST_BOX_PAPER", FIRST_BOX_PAPER},
  {"FIRST_BOX_SNOW", FIRST_BOX_SNOW},
  {"FIRST_FLOOR_DANGER", FIRST_FLOOR_DANGER},
  {"FIRST_FLOOR_ELEVATORS", FIRST_FLOOR_ELEVATORS},
  {"FIRST_FLOOR_GRAY", FIRST_FLOOR_GRAY},
  {"FIRST_LIGHT_BOX", FIRST_LIGHT_BOX},
  {"FIRST_TNT_BRIGHT", FIRST_TNT_BRIGHT},
  {"FIRST_TNT_DARK", FIRST_TNT_DARK},
  {"FIRST_TNT_PAPER", FIRST_TNT_PAPER},
  {"FIRST_TNT_SNOW", FIRST_TNT_SNOW},
  {"FIRST_TNT_SWAMP", FIRST_TNT_SWAMP},
  {"FIRST_WALL_IRON_BLUE", FIRST_WALL_IRON_BLUE},
  {"FIRST_WALL_IRON_BROWN", FIRST_WALL_IRON_BROWN},
  {"FIRST_WALL_IRON_DARK", FIRST_WALL_IRON_DARK},
  {"FIRST_WALL_IRON_GRAY", FIRST_WALL_IRON_GRAY},
  {"FIRST_WALL_MACHINE", FIRST_WALL_MACHINE},
  {"FIRST_WALL_REPRO", FIRST_WALL_REPRO},
